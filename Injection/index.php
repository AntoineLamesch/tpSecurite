	...
	<div class='limiter'>
		<div class='container-login100' style='background-image: url('images/bg-01.jpg');'>
			<div class='wrap-login100 p-l-110 p-r-110 p-t-62 p-b-33'>
				<form class='login100-form validate-form flex-sb flex-w' method='post' action='./connect.php'>
					...
					<div class='container-login100-form-btn m-t-17'>
						<input class='login100-form-btn' type='submit' value='Connexion non sécurisée' formaction='connect.php'>
						</input>
					</div>

					<div class='container-login100-form-btn m-t-17'>
						<input class='login100-form-btn' type='submit' value='Connexion sécurisée' formaction='connect_secur.php'>
						</input>
					</div>
					...
					<div class='w-full text-center p-t-55'>
						...
						<a href='./inscription.php' class='txt2 bo1'>
							Inscrivez-vous !! 
						</a>
					</div>
				</form>
