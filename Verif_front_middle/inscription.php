		...
		<div class='container-login100' style='background-image: url('images/bg-01.jpg');'>
			<div class='wrap-login100 p-l-110 p-r-110 p-t-62 p-b-33'>
				<form class='login100-form validate-form flex-sb flex-w' method='post' action='./create_1.php'>
					...
					<div class='wrap-input100 validate-input' data-validate = 'Une date de naissance est requise'>
					...
					<div class='container-login100-form-btn m-t-17'>
						<input class='login100-form-btn' type='submit' value='Inscription'>
						</input>
					</div>
					...
					<div class='w-full text-center p-t-55'>
						...
						<a href='./connexion.php' class='txt2 bo1'>
							Connectez-vous !! 
						</a>
					</div>
				</form>
